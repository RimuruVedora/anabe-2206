    ...
    <form action="code.php" method="POST">
      <div class="user-details">
        ...
        <div class="input-box">
          ...
          <input type="text" name="position" placeholder="Enter your position desired" required>
        </div>
        <div class="input-box">
          <span class="details">Educational Background</span>
          <textarea name="education" placeholder="Enter your educational background" cols="30" rows="10" required></textarea>
        </div>
      </div>
