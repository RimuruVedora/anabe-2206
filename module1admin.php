                                ...
                                if(mysqli_num_rows($query_run) > 0)
                                {
                                    foreach($query_run as $applicant)
                                    {
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                            <a href="update.php?id=<?= $applicant['Applicant_No']; ?>" class="btn btn-success btn-sm">Edit</a>
                                                <a href="view.php?id=<?= $applicant['Applicant_No']; ?>" class="btn btn-info btn-sm">View</a>                                       
...
<div id="notification" class="notification">
  <p>You sure you want to delete this  applicant?</p>
